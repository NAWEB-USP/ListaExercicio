...
<script type="text/javascript" charset="utf-8"
	src="<c:url value="/javascript/jquery.validate.min.js"/>"></script>
<script type="text/javascript" charset="utf-8">
  	...
  	<table border="0">
    	<tr>
			...
			<td width="750" align="left" valign="top">    
				...
				<h1><a href="index.html">Alterar Professor</a></h1>
				
			<form id="alteracao" action='altera' method="post"
				accept-charset="utf-8">
				<fieldset>
					Digite os novos dados cadastrais <input type="hidden" size="30"
						name="id" value="${administrador.id}" /> <br />
					<p>
						<label>Nome: </label><input type="text" size="30" name="novoNome"
							value="${administrador.nome}" />
					</p>
					<p>
						<label>E-mail : </label><input type="text" size="30"
							name="novoEmail" value="${administrador.email}" />
					</p>
					<p>
						<label>Senha : </label><input id="senha" type="password" size="30"
							name="novaSenha" />
					</p>
					<p>
						<label>Confirmar senha : </label><input type="password" size="30"
							name="confirmaSenha" />
					</p>
					<p class="submit">
